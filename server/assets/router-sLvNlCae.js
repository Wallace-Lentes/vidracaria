...
const appCss = "/assets/styles-Ve9LphWp.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Vidraçaria Ramos — Vidros, Esquadrias e Alumínio" },
      { name: "description", content: "Instalação de janelas, portas, box, esquadrias de alumínio e guarda-corpo. Orçamento grátis em São Paulo." },
...
const heroImg = "/assets/hero-glass-d93kgZb8.jpg";
const $$splitComponentImporter = () => import("./index-DVcnkcSL.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Vidraçaria Ramos: instalação de janelas, portas, box de banheiro, esquadrias de alumínio e guarda-corpo. Orçamento rápido e sem compromisso."
    }, {
      property: "og:title",
      content: "Vidraçaria Ramos — Vidros e Esquadrias sob Medida"
    }, {
      property: "og:description",
      content: "Mais de 20 anos em vidros temperados, alumínio e instalações premium. Orçamento grátis."
    }, {
      property: "og:image",
      content: heroImg
    }, {
